    ...
    <div className="h-full">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
          ...
          <Line type="monotone" dataKey="total_wealth" stroke="#0f766e" strokeWidth={3} dot={false} name="Total Wealth" />
          <Line type="monotone" dataKey="avg_wealth" stroke="#14b8a6" strokeWidth={3} dot={false} name="Avg Wealth" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
