    ...
    <div className="h-full min-h-24 lg:min-h-26">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 5, right: 10, left: 0, bottom: 5 }}>
          ...
          <Line type="monotone" dataKey="avg_power" stroke="#0f766e" strokeWidth={3} dot={false} name="Avg Power" />
          <Line type="monotone" dataKey="max_power" stroke="#115e59" strokeWidth={3} strokeDasharray="4 2" dot={false} name="Max Power" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
